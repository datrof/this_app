...
function exit_code = this(path)
    ...
    pdm_2d_rot_global = zeros(16,16,numel(listing)*n_of_frames_in_packet);
    diag_global = zeros(16,numel(listing)*n_of_frames_in_packet);
    ...
    save([path '/global.mat'], 'this_ver', 'this_sub_ver', 'lightcurvesum_global', 'pdm_2d_rot_global', 'diag_global', 'unixtime_global', 'd3_period_us', 'cwt_global', '-v7.3');
